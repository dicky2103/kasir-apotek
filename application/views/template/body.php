...
<html lang="en">
	<head>
		...
		<link rel="icon" href="<?php echo base_url('assets/images/sehat.jpeg') ?>" type="image/ico" />
		...
		<div class="container body">
			<div class="main_container">
				...
				<div class="right_col" role="main">
					...
					<a href="<?php echo base_url(); ?>"></span><img src="<?php echo base_url('assets/images/') ?>" alt="..." class="img-home"></a>
						<div class="clearfix"></div>
				</div>
				</div>
